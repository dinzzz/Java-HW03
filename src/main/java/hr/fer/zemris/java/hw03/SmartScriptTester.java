...
public class SmartScriptTester {
	...
	public static void main(String[] args) throws IOException {
		...
		// (UPWARDS)FOR THIS AND ANY OTHER SmartScriptTesterXX - This exception will be
		// caught for all exception besides ParserException and LexerException - No
		// point in doing 20 different catches
		// for other ex's like IllegalArgumentException, NullpointerException etc.
